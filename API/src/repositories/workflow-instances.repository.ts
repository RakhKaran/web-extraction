...
>(DefaultCrudRepository) {
  ...
  constructor(@inject('datasources.web_scrapper') dataSource: WebScrapperDataSource, @repository.getter('WorkflowRepository') protected workflowRepositoryGetter: Getter<WorkflowRepository>,) {
