...
import { useGetCompanies } from 'src/api/companyList';
// components
...
import CompanyListTableRow from '../companyList-table-row';
...
export default function CompanyListListView() {
  ...
  const handleDeleteRows = useCallback(() => {
    table.onUpdatePageDeleteRows({
      totalRows: CompaniesList.length,
      totalRowsInPage: dataInPage.length,
      totalRowsFiltered: dataFiltered.length,
    });
  }, [dataFiltered.length, dataInPage.length, CompaniesList.length, table]);
    ...
    <>
      <Container maxWidth={settings.themeStretch ? false : 'lg'}>
        ...
        <Card>
          ...
          <CompanyListTableToolbar filters={filters} onFilters={handleFilters} />

          {canReset && (
            <CompanyListTableFiltersResult
              filters={filters}
            ...
            <Scrollbar>
              <Table size={table.dense ? 'small' : 'medium'} sx={{ minWidth: 960 }}>
                ...
                <TableBody>
                  ...
                  <TableEmptyRows
                    height={denseHeight}
                    emptyRows={emptyRows(table.page, table.rowsPerPage, CompaniesList.length)}
                  />
